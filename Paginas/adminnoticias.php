...
<body>
  ...
  <div class="row align-items-center">
      ...
      <div class="col-auto">
        ...
        <div class="col-12 d-flex justify-content-center"><a href="añadirnoticia.php"><button class="btn btn-primary" type="button">Añadir noticia</button></a></div>
        </div>
      </div>
    </div>
  </div>
...
<?php
    if (isset($_POST['eliminar'])) {
        $sql1 = 'DELETE FROM Noticias WHERE IdNoticia=' . $_REQUEST["idborrar"];
        $resultado1 = $dwes->query($sql1);
    }


  if (!isset($error)) {
    $sql = "SELECT DISTINCT * FROM Noticias ORDER BY IdNoticia DESC ";
            ...
            <div class='d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1'>
              ...
              <ul class='d-flex list-unstyled mt-auto'>
                ...
                <li class='d-flex align-items-center me-2'>
                    <form name='input' action='adminnoticias.php' method='post' ENCTYPE='multipart/form-data'>
