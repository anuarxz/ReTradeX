...
<body>
  ...
  <?php
        if (!isset($_SESSION['correo'])) {
          $boton = '<button type="button" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip" data-bs-title="Regístrate o inicia sesión para crear un nuevo tema">
                      Crear nuevo tema
                  </button';
        }else{
            $boton = '<a href="creartemaforo.php"><button type="button" class="btn btn-primary">Crear nuevo tema</button></a>';
        }
?> 


  <div class="container px-4 py-5 mb-0" id="custom-cards">
  <div class="row align-items-center">
      <div class="col">
        <h1 class="d-inline">Foro   
        <?php echo $boton; ?>
      </h1>
      </div>
      <div class="col-auto">
